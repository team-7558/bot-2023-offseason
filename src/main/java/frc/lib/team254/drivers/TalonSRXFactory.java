...
public class TalonSRXFactory {
  ...
  static {
    ...
    kFollowerConfiguration.MOTION_CONTROL_FRAME_PERIOD_MS = 1007;
    kFollowerConfiguration.GENERAL_STATUS_FRAME_RATE_MS = 1006;
    kFollowerConfiguration.FEEDBACK_STATUS_FRAME_RATE_MS = 1005;
    kFollowerConfiguration.QUAD_ENCODER_STATUS_FRAME_RATE_MS = 1003;
    kFollowerConfiguration.ANALOG_TEMP_VBAT_STATUS_FRAME_RATE_MS = 1002;
    kFollowerConfiguration.PULSE_WIDTH_STATUS_FRAME_RATE_MS = 1001;
