...
import frc.lib.team7558.magEncoder.MagEncoderDIO;
...
public class SwerveModuleIOTalonFX implements SwerveModuleIO {
  ...
  private MagEncoderDIO angleEncoder;
  ...
  private void configAngleEncoder(int canCoderID) {
    angleEncoder = new MagEncoderDIO(canCoderID);
  }
  ...
  private void configAngleMotor(int angleMotorID) {
    ...
    angleMotorConfig.GENERAL_STATUS_FRAME_RATE_MS = 20;
    angleMotorConfig.FEEDBACK_STATUS_FRAME_RATE_MS = 20;
    angleMotorConfig.ANALOG_TEMP_VBAT_STATUS_FRAME_RATE_MS = 137;
    angleMotorConfig.MOTION_MAGIC_STATUS_FRAME_RATE_MS = 139;
    angleMotorConfig.BASE_PIDF0_STATUS_FRAME_RATE_MS = 149;
  ...
  private void configDriveMotor(int driveMotorID) {
    ...
    driveMotorConfig.GENERAL_STATUS_FRAME_RATE_MS = 20;
    driveMotorConfig.FEEDBACK_STATUS_FRAME_RATE_MS = 20;
    driveMotorConfig.ANALOG_TEMP_VBAT_STATUS_FRAME_RATE_MS = 149;
    driveMotorConfig.MOTION_MAGIC_STATUS_FRAME_RATE_MS = 151;
    driveMotorConfig.BASE_PIDF0_STATUS_FRAME_RATE_MS = 157;
  ...
  /** Calibrates the offset for the angle motor. */
  @Override
  public void calibrateAngleMotor() {
    double absolutePosition =
        Conversions.degreesToFalcon(getCanCoder().getDegrees() - angleOffsetDeg, angleGearRatio);
    mAngleMotor.setSelectedSensorPosition(absolutePosition);
  }
