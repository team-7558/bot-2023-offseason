...
public class HolonomicPathFollowerConfig {
   ...
   *
   * @param translationConstants {@link frc.ppnew.lib.util.PIDConstants} used for creating the
   *     translation PID controllers
   * @param rotationConstants {@link frc.ppnew.lib.util.PIDConstants} used for creating the
