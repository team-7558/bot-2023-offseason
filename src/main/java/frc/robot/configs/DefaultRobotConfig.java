...
public class DefaultRobotConfig extends RobotConfig {
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET = 24.4;

  private static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 3;
  private static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 7;
  private static final int FRONT_RIGHT_MODULE_STEER_ENCODER = 2;
  private static final double FRONT_RIGHT_MODULE_STEER_OFFSET = 197.2;

  private static final int BACK_LEFT_MODULE_DRIVE_MOTOR = 1;
  private static final int BACK_LEFT_MODULE_STEER_MOTOR = 5;
  private static final int BACK_LEFT_MODULE_STEER_ENCODER = 1;
  private static final double BACK_LEFT_MODULE_STEER_OFFSET = 336.2;

  private static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 4;
  private static final int BACK_RIGHT_MODULE_STEER_MOTOR = 8;
  private static final int BACK_RIGHT_MODULE_STEER_ENCODER = 3;
  private static final double BACK_RIGHT_MODULE_STEER_OFFSET = 59.6;

  private static final int GYRO_ID = 18;

  private static final double TRACKWIDTH_METERS = Units.inchesToMeters(28);
  private static final double WHEELBASE_METERS = Units.inchesToMeters(28);
  private static final double ROBOT_WIDTH_WITH_BUMPERS = Units.inchesToMeters(28 + 6);
  private static final double ROBOT_LENGTH_WITH_BUMPERS = Units.inchesToMeters(28 + 6);
  ...
  private static final double MAX_VELOCITY_METERS_PER_SECOND =
      4.945; // 4.25; // NOTE: actual is 4.96824
  private static final double MAX_COAST_VELOCITY_METERS_PER_SECOND = 0.05;

  // The name of the CANivore CAN FD bus as appropriate (an empty string uses the default CAN bus)
  ...
  private static final int PNEUMATICS_HUB_ID = 49; // TODO: this today
  ...
  private static final double AUTO_MAX_SPEED_METERS_PER_SECOND = 3.0;
  private static final double AUTO_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED = 2.5;
  private static final double AUTO_DRIVE_P_CONTROLLER = 0.6; // 5;//0.6;
  private static final double AUTO_DRIVE_I_CONTROLLER = 0.0;
  private static final double AUTO_DRIVE_D_CONTROLLER = 0.0;
  private static final double AUTO_TURN_P_CONTROLLER = 3.0; // 10.0;
