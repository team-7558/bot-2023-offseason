...
public class SierraRobotConfig extends RobotConfig {
  ...
  // NOTE: Don't use me I am bad boy
  ...
  private static final double FRONT_LEFT_MODULE_STEER_OFFSET = 0; // 119.26;
  ...
  private static final double AUTO_MAX_SPEED_METERS_PER_SECOND = 0.3; // 2.0;
  private static final double AUTO_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED = 0.3; // 2.0;
